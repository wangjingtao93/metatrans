...
def creat_multi_tasks(res):
    store_path = os.path.join(relative_path, f'data/lymph/camely/camely_16/splite_by_node/{res}/balance/multi_tasks/')
    os.mkdir(store_path)
    df_train = pd.read_csv(os.path.join(relative_path,f'data/lymph/camely/camely_16/splite_by_node/{res}/balance/train_{res}.csv'))
    df_val = pd.read_csv(os.path.join(relative_path,f'data/lymph/camely/camely_16/splite_by_node/{res}/balance/val_{res}.csv'))
