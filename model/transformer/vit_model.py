...
def vit_base_patch16_224(num_classes: int = 1000, depth: int = 12):
    """
...
def vit_small_patch16_224(num_classes: int = 1000, depth: int = 12):
    model = VisionTransformer(img_size=224,
                              patch_size=16,
                              embed_dim=384,
                              depth=depth,
...
if __name__ == '__main__':
    ...
    model = vit_small_patch16_224(num_classes=2).to(device)
